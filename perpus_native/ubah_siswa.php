...
<body>
    <?php 
        include "koneksi.php";
        $qry_get_siswa=mysqli_query($conn,"select * from data_siswa where id_siswa = '".$_GET['id_siswa']."'");
    ...
    <form action="proses_ubah_siswa.php" method="post">
        ...
        <input type="submit" name="simpan" value="Ubah Siswa" class="btn btn-primary mt-3">
    </form>
